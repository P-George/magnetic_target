function [induce, eddy, permanent, Hex, Hey, Hez, X,Y,Z,total,H,latitude,longitude,height] = start_simulate(fg_file)
R = 6340000;
[permanent_loc, permanent_dipo, induce_loc, induce_u, eddy_loc, eddy_R, eddy_radius] = init_set();
[longitude, latitude, height, roll, pitch, heading] = get_location_attitude(fg_file);
...
[X,Y,Z, total] = add_He_interference(He, permanent, induce, eddy);
